...
/* Stub functions for async interface - return NULL as not implemented */
static struct composite_context *simple_IUnknown_QueryInterface_async(struct IUnknown *d, TALLOC_CTX *mem_ctx, struct GUID *iid)
{
	return NULL; /* Not implemented */
}

static struct composite_context *simple_IUnknown_AddRef_async(struct IUnknown *d, TALLOC_CTX *mem_ctx)
{
	return NULL; /* Not implemented */
}

static struct composite_context *simple_IUnknown_Release_async(struct IUnknown *d, TALLOC_CTX *mem_ctx)
{
	return NULL; /* Not implemented */
}

static struct composite_context *simpleclass_IClassFactory_CreateInstance_async(struct IClassFactory *d, TALLOC_CTX *mem_ctx, struct MInterfacePointer *iunk, struct GUID *iid)
{
	return NULL; /* Not implemented */
}

static struct composite_context *simple_IStream_Read_async(struct IStream *d, TALLOC_CTX *mem_ctx, uint32_t num_requested, uint32_t *num_read)
{
	return NULL; /* Not implemented */
}

static struct composite_context *simple_IStream_Write_async(struct IStream *d, TALLOC_CTX *mem_ctx, uint8_t *data, uint32_t num_requested)
{
	return NULL; /* Not implemented */
}
...
static struct IClassFactory_vtable simple_classobject_vtable = {
	...
	simple_IUnknown_QueryInterface_async,
	simple_IUnknown_AddRef_async,
	simple_IUnknown_Release_async,
	simpleclass_IClassFactory_CreateInstance_async,
	NULL,
	NULL,
	NULL
};
...
static struct IStream_vtable simple_IStream_vtable = {
	...
	simple_IUnknown_AddRef_async,
	simple_IUnknown_Release_async,
	simple_IStream_Read_async,
	simple_IStream_Write_async
};
